...
const Type2 = (props: {params: any, gen: any, setFinish: any, nbError:number, setNbError:any, solveur: any}) : JSX.Element => {
    ...
    return (
        <div>
             <div className={classes.problem}>
                ...
                <p>Vous <strong>commencez</strong> vos plat à <strong>{startTime.hour} h {startTime.min}</strong> </p>
